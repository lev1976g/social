...
<div class="wallrecord comm_wr news_comm_wr" id="wall_record_{rec-id}" style="padding-bottom:4px;margin-top:5px">
  <div style="float:left;width:60px">
    <div class="ava_mini">
      <a href="/{link}{author-id}" onClick="Page.Go(this.href); return false"><img src="{ava}" alt="" /></a>
      {online}</div>
  </div>
  <div style="float:left;width:710px;margin-left:0px">
    <div class="wallauthor" >
      <a href="/{link}{author-id}" onClick="Page.Go(this.href); return false">{author}</a>
    ...
    <div class="infowalltext_f clear">
      <div class="fl_l">{action-type} {date} [comments-link]<span id="fast_comm_link_{rec-id}" class="fast_comm_link">&nbsp;|&nbsp;
        ...
        </span>[/comments-link]</div>
      [wall]
      <div class="public_likes_user_block no_display" id="public_likes_user_block{rec-id}" onMouseOver="groups.wall_like_users_five('{rec-id}'[wall-func], 'uPages'[/wall-func])" onMouseOut="groups.wall_like_users_five_hide('{rec-id}')" style="margin-left:585px">
...
[/all-comm]
[comment]
<div class="wall_fast_block" id="wall_fast_comment_{comm-id}" onMouseOver="ge('fast_del_{comm-id}').style.display = 'block'" onMouseOut="ge('fast_del_{comm-id}').style.display = 'none'">

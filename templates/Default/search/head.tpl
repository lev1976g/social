...
maxlength="65" />
  ...
  <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="margin-top:10px;height:22px">
    ...
    <div class="{activetab-2}"><a href="/?go=search{query-groups}" onClick="Page.Go(this.href); return false;">
        <div><b>Сообщества</b></div>
      </a>
    </div>
    <div class="{activetab-3}"><a href="/?go=search{query-videos}" onClick="Page.Go(this.href); return false;">
        <div><b>Видеозаписи</b></div>
      </a>
    </div>
    <div class="{activetab-4}"><a href="/?go=search{query-hashtags}" onClick="Page.Go(this.href); return false;">
        <div><b>Записи</b></div>
      </a>
    </div>
  </div>
...
<div class="search_result_title">{count}</div>
[/yes]
